...
# Или "Russian_Russia.1251", если данные на кириллице
...
def r_randomforestsrc_importance(X, y, n_estimators=100, max_depth=None, min_samples_leaf=5, max_features='sqrt'):
    ...
    Args:
        ...
        n_estimators (int): Количество деревьев (ntree в R)
    ...
    try:
        ...
        if is_classification:
            ...
            # Для регрессии используем числовые значения
        ...
        # Создание pandas Series с оригинальными именами признаков
...
def r_randomforest_importance(X, y, n_estimators=100, max_depth=None, min_samples_leaf=1, max_features='sqrt'):
    ...
    try:
        ...
        # Извлечение только первого столбца
